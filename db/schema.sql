...
CREATE TABLE IF NOT EXISTS pricing_guardrails (
    ...
    min_margin_pct NUMERIC(5, 4) NOT NULL DEFAULT 0.0500,
    max_price_volatility_pct NUMERIC(5, 4) NOT NULL DEFAULT 0.1500,
    map_price NUMERIC(12, 2),
    is_active BOOLEAN DEFAULT TRUE,
    updated_at TIMESTAMPTZ DEFAULT NOW()
);

-- 5. Pricing Decisions (MDP State-Action Log & EBITDA Tracking)
...
-- 8. Vendor Contracts & MAP Constraints
...
-- 10. Realtime SKU Pricing State Space
CREATE TABLE IF NOT EXISTS sku_pricing_state (
    ...
    last_action NUMERIC(6, 4) NOT NULL DEFAULT 0,
...
-- 11. Aggregate Commercialization Metrics
